...
import com.grace.web.system.mapper.SysRoleDeptMapper;
import com.grace.web.system.mapper.SysRoleMapper;
import com.grace.web.system.mapper.SysRoleMenuMapper;
import com.grace.web.system.mapper.SysUserRoleMapper;
    ...
    public Set<String> selectRolePermissionByUserId(Long userId) {
        ...
        for (SysRole perm : perms) {
            if (ObjectUtil.isNotNull(perm)) {
                permsSet.addAll(Arrays.asList(perm.getRoleKey().trim().split(StrUtil.COMMA)));
            }
        }
        return permsSet;
    }
