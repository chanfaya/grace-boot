...
import com.grace.web.system.domain.vo.MetaVo;
import com.grace.web.system.domain.vo.RouterVo;
import com.grace.web.system.mapper.SysMenuMapper;
import com.grace.web.system.mapper.SysRoleMapper;
import com.grace.web.system.mapper.SysRoleMenuMapper;
    ...
    public Set<String> selectMenuPermsByUserId(Long userId) {
        ...
        for (String perm : perms) {
            if (StrUtil.isNotEmpty(perm)) {
                permsSet.addAll(Arrays.asList(perm.trim().split(StrUtil.COMMA)));
            }
        }
        return permsSet;
    }
